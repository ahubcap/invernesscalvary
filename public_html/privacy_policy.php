<?php $pagenav = "privacy_policy";
	  $path = $_SERVER['DOCUMENT_ROOT'];
?>
<?php include 'assets/includes/htmlhead.php'; ?>
	<body id="privacy_policy" class="inner_page">
...
<style type="text/css" media="all">
	...
	div#content { width: 100%; margin-top: 6px; margin-bottom: 60px;}
			...
			<div id="mid_blocks">
				<p id="breadcrumb"><a href="/">HOME</a> &bull; PRIVACY POLICY</p>
				<div id="content">
					<h1>Calvary Church Privacy Policy</h1>
					...
					When ordering or registering on our site, as appropriate, you may be asked to enter your: name, email address, mailing address or phone number. You may, however, visit our site anonymously.</p>
					...
					<ul class="bullets">
						<li><span>To personalize your experience:</span> your information helps us to better respond to your individual needs.</li>
						<li><span>To improve our website:</span> we continually strive to improve our website offerings based on the information and feedback we receive from you.</li>
						...
						<li><span>To administer:</span> a contest, promotion, survey or other site feature.</li>
						<li><span>To send periodic emails:</span> The email address you provide for order processing will only be used to send you information and updates pertaining to your order.</li>
					</ul>
					<p>Note: If at any time you would like to unsubscribe from receiving future emails, we include detailed unsubscribe instructions at the bottom of each email.
					...
					<p>Yes. Cookies are small files that a site or its service provider transfers to your computer's hard drive through your Web browser (if you allow they enable the site’s or service provider's systems to recognize your browser and capture and remember certain information. We use cookies to understand and save your preferences for future visits, keep track of advertisements and compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future. We may contract with third-party service providers to assist us in better understanding our site visitors. These service providers are not permitted to use the information collected on our behalf except to help us conduct and improve our business.</p>
					...
					<p>Because we value your privacy, we have taken the necessary precautions to be in compliance with the California Online Privacy Protection Act. We therefore will not distribute your personal information to outside parties without your consent. As part of the California Online Privacy Protection Act, all users of our site may make any changes to their information at any time by logging into their control panel and going to the 'Edit Profile' page.</p>
					Children’s Online Privacy Protection Act Compliance
					We are in compliance with the requirements of COPPA (Children’s Online Privacy Protection Act), we do not collect any information from anyone under 13 years of age. Our website, products and services are all directed to people who are at least 13 years of age or older.</p>
					...
					This policy was last modified on August 1st, 2012.</p>
					<h2>Company Contact Information</h2>
					<p>
					Calvary Church<br />
					2728 E. Harley Street<br />
					Inverness, Florida 34453<br /><br />
					352-637-5100<br />
					<strong><a href="mailto:contact@invernesscalvary.com">contact@invernesscalvary.com</a></strong>
					</p>				
				</div>
			</div>
