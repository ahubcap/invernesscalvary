...
function displayfeed(result)
{
	if (!result.error){
		...
		for (var i=0; i<thefeeds.length; i++){
			rssoutput+="<li"+(i==2?' class="last"':'')+"><a class=\"readlink\" href='" + thefeeds[i].link + "'>READ</a><a class=\"titlelink\" href='" + thefeeds[i].link + "'><h2>" + thefeeds[i].title + "<span>, "+$.datepicker.formatDate('mm.dd.yy', new Date(Date.parse(thefeeds[i].publishedDate)))+"</span></h2></a><p>" + thefeeds[i].author + "</p></li>";
		}
		rssoutput+="</ul>";
...
$(document).ready(function() {
	...
	if(opersys.match(/(iPhone|iPod|iPad)/i)){
		...
		var put2 = '<div id="ministries_block"><a href="/ministries/"><div id="ministries_pic"></div></a><ul><li><a href="/ministries/for_kids/">Ministries for Kids</a></li><li><a href="/ministries/for_adults/">Ministries for Adults</a></li></ul><ul class="min_ul_02"><li><a href="/ministries/for_teens/">Ministries for Teens</a></li><li><a href="/ministries/serve/">Ways to Serve</a></li></ul></div><a href="http://www.itunes.com/podcast?id=332983622"><div id="audio"></div></a><a href="/get_involved/"><div id="involved"></div></a>';
