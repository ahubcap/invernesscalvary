<?php $resources = '
				<li class="top_shelf subnav'.($dom=='sitemap'?' section':'').'"><a class="top_a" href="/resources/">RESOURCES</a>
					<ul class="drop_01 secondary">
						...
						<li><a class="'.($pagenav=='blog/sermon-archive'?' current':'').'" href="http://invernesscalvary.com/resources/blog/sermon-archive">Audio Sermons</a></li>
						...
						<!--li><a class="hash01" href="/resources/#videos_and_photos">Videos &amp; Photos</a></li-->
...
<?php if($dom == 'side') :?>
		...
		<div rel="230" id="side_nav_02" class="tab<?php echo ($pagenav=='get_involved'?' clicked':''); ?>">
			<ul>
<?php endif ;?>
		<?php if($dom == "sitemap") :?>
			</ul>
		...
		<?php endif ;?>
				<li class="top_shelf subnav<?php echo ($dom=='sitemap'?' section':''); ?>"><a class="top_a" href="/get_involved/">GET INVOLVED</a>
					<ul class="drop_07 secondary">
						...
						<li><a class="hash05" href="/get_involved/#donate_to_calvary">Donate to Calvary</a></li>
					</ul>
				</li>
<?php if($dom == 'side') :?>
			</ul>
		...
		<?php endif ;?>
				<li class="top_shelf subnav<?php echo ($dom=='sitemap'?' section':''); ?>"><a class="top_a" href="/who_we_are/">WHO WE ARE</a>
					<ul class="drop_03 secondary">
						<li><a class="hash01" href="/who_we_are/#our_mission">Our Mission &amp; Vision</a></li>
...
<?php if($dom == 'side') :?>
		...
		<div rel="285" id="side_nav_04" class="tab<?php echo ($pagenav=='ministries'?' clicked':''); ?>">
			<ul>
<?php endif ;?>
				<li class="top_shelf section"><a class="top_a" href="/ministries/">MINISTRIES</a>
					<ul class="drop_04 secondary">
						<li class="subnav<?php echo ($urlArr[2] && $urlArr[2]=='for_kids' ? ' clicked' : ''); ?>"><?php echo ($dom=='side'?'<span class="arrowlink">&nbsp;</span>':''); ?><a href="/ministries/for_kids/"><span>For Kids</span></a>
							<ul>
								<li><a class="hash01" href="/ministries/for_kids/#nursery">Nursery</a></li>
								<li><a class="hash02" href="/ministries/for_kids/#wee_church">Wee-Church</a></li>
								<li><a class="hash03" href="/ministries/for_kids/#calvary_kids">Calvary Kids</a></li>
								<li><a class="hash04" href="/ministries/for_kids/#high_point">Life Group Kids</a></li>
								<!-- <li><a class="hash05" href="/ministries/for_kids/#agape_daycare_and_preschool">Agape Daycare &amp; Preschool</a></li> -->	
							</ul>
						</li>
						<li class="subnav<?php echo ($urlArr[2] && $urlArr[2]=='for_teens' ? ' clicked' : ''); ?>"><?php echo ($dom=='side'?'<span class="arrowlink">&nbsp;</span>':''); ?><a href="/ministries/for_teens/"><span>For Teens</span></a>
							<ul>
								<li><a class="hash01" href="/ministries/for_teens/#the_well">The Well - Youth Group</a></li>
								<li><a class="hash02" href="/ministries/for_teens/#the_furnace">The Furnace - Prayer</a></li>
								<li><a class="hash03" href="/ministries/for_teens/#youth_small_groups">Youth Small Groups</a></li>
								<li><a class="hash04" href="/ministries/for_teens/#discipleship">Discipleship</a></li>
								<li><a class="hash05" href="/ministries/for_teens/#more">MORE</a></li>
							</ul>
						</li>
						<li class="subnav<?php echo ($urlArr[2] && $urlArr[2]=='for_adults' ? ' clicked' : ''); ?>"><?php echo ($dom=='side'?'<span class="arrowlink">&nbsp;</span>':''); ?><a href="/ministries/for_adults/"><span>For Adults</span></a>
							<ul>
								<!--li><a class="hash01" href="/ministries/for_adults/#axis_young_adults">Axis Young Adults</a></li-->
								<li><a class="hash02" href="/ministries/for_adults/#adult_life_group">Life Groups</a></li>
								<li><a class="hash03" href="/ministries/for_adults/#citrus_prayer_group">Citrus Prayer Room</a></li>
								<li><a class="hash04" href="/ministries/for_adults/#missions">Missions</a></li>
								<!--li><a class="hash05" href="/ministries/for_adults/#every_home_for_christ">Every Home for Christ</a></li-->
								<!--li><a class="hash06" href="/ministries/for_adults/#celebrate_freedom">Celebrate Freedom</a></li-->
								<li><a class="hash07" href="/ministries/for_adults/#aa-support-group">AA Support Group</a></li>
							</ul>
						</li>
						<li class="subnav<?php echo ($urlArr[2] && $urlArr[2]=='serve' ? ' clicked' : ''); ?>"><?php echo ($dom=='side'?'<span class="arrowlink">&nbsp;</span>':''); ?><a href="/ministries/serve/"><span>Serve</span></a>
							<ul class="last">
								...
								<li><a class="hash02" href="/ministries/serve/#usher_team">Usher Team</a></li>
		...
		<div rel="207" id="side_nav_05" class="tab<?php echo (($pagenav=='resources' || $pagenav=='blog')?' clicked':''); ?>">
			<ul>
				<?php echo $resources; ?>
			</ul>
		</div>
